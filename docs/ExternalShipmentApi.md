...
ExternalShipmentApi apiInstance = new ExternalShipmentApi();
ExecuteExternalShipmentInputAPIModel body = new ExecuteExternalShipmentInputAPIModel(); // ExecuteExternalShipmentInputAPIModel | Input data for ExecuteExternalShipment process.
try {
