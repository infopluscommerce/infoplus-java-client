...
public class ExternalShipmentApiTest {
     ...
     */
    @Test
    public void executeExternalShipmentTest() throws ApiException {
        ExecuteExternalShipmentInputAPIModel body = null;
        List<ProcessOutputAPIModel> response = api.executeExternalShipment(body);
