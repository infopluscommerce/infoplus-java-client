...
public class FulfillmentProcessLogApiTest {
     ...
     */
    @Test
    public void addFulfillmentProcessLogFileByURLTest() throws ApiException {
        RecordFile body = null;
        Integer fulfillmentProcessLogId = null;
        api.addFulfillmentProcessLogFileByURL(body, fulfillmentProcessLogId);
     ...
     */
    @Test
    public void deleteFulfillmentProcessLogFileTest() throws ApiException {
        Integer fulfillmentProcessLogId = null;
        Integer fileId = null;
        api.deleteFulfillmentProcessLogFile(fulfillmentProcessLogId, fileId);
     ...
     */
    @Test
    public void getFulfillmentProcessLogFilesTest() throws ApiException {
        Integer fulfillmentProcessLogId = null;
        api.getFulfillmentProcessLogFiles(fulfillmentProcessLogId);
