...
public class QuickAdjustment {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, warehouseId, locationId, adjustmentCode, totalQuantity, changeQuantity, message, status, productIdTag, createDate, modifyDate, customFields, sku);
  }
