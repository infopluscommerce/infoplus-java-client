  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, orderLine.id) &&
        ...
        Objects.equals(this.productIdTag, orderLine.productIdTag) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, lineItemId, customerLineItemNo, orderNo, lobId, sku, poNoId, orderedQty, allowedQty, shippedQty, backorderQty, numberOfWraps, numberOfCases, numberOfInnerPacks, revDate, chargeCode, distributionCode, upc, vendorSKU, orderSourceSKU, unitCost, unitSell, unitDiscount, unitDeclaredValueOverride, extendedCost, extendedSell, extendedDiscount, ncExtendedSell, extendedDeclaredValueOverride, itemWeight, productionLot, productIdTag, expirationDate, weightPerWrap, sector, orderAssemblyInstructions, itemAccountCodeId, itemLegacyLowStockContactId, itemMajorGroupId, itemSubGroupId, itemProductCodeId, itemSummaryCodeId, fulfillmentChannel, dynamicKitComponentList, overrideReceiptsForFulfillmentList, customFields);
  }
