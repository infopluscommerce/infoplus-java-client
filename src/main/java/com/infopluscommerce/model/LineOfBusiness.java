...
public class LineOfBusiness {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, code, label, defaultWarehouseServiceTypeId, defaultSLAServiceDays, defaultSLACutoffTime, onHold, onHoldReason, createDate, modifyDate, customFields);
  }
