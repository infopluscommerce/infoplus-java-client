...
public class EdiDocument {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, ediConnectionId, lobId, transactionType, direction, documentTypeId, status, interchangeIndex, groupIndex, transactionIndex, body, jsonBody, createDate, modifyDate, customFields);
  }
