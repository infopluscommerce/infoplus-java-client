...
public class ParcelAccount {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, createDate, modifyDate, carrierCompany, accountNo, client, ipcDatabaseId, name, manifestPartnerId, manifestPartnerCredentials, customFields);
  }
