...
public class Work {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, sourceWarehouseId, sourceBuildingId, sourceLocation, destinationWarehouseId, destinationBuildingId, destinationLocation, type, createDate, modifyDate, priorityCode, userDefinedMessage, status, userId, lobId, workBatchId, customFields);
  }
