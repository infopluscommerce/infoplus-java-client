...
public class QuickReceipt {
  ...
  @SerializedName("itemSerials")
  private List<String> itemSerials = null;
  ...
  **/
  ...
  public QuickReceipt itemSerials(List<String> itemSerials) {
    this.itemSerials = itemSerials;
    return this;
  }

  public QuickReceipt addItemSerialsItem(String itemSerialsItem) {
    if (this.itemSerials == null) {
      this.itemSerials = new ArrayList<String>();
    }
    this.itemSerials.add(itemSerialsItem);
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, quickReceipt.id) &&
        ...
        Objects.equals(this.itemSerials, quickReceipt.itemSerials) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, createdBy, createDate, modifyDate, warehouseId, lobId, sku, locationId, quantity, itemSerials, vendorId, carrier, status, unitCode, wrapCode, weightPerWrap, unitsPerWrap, quantityPerInnerPack, unitsPerCase, quantityPerPallet, caseWeight, productionLot, revisionDate, origin, cartonLength, cartonWidth, cartonHeight, cost, sellPrice, pricingPer, generatedItemReceiptId, generatedASNId, dockDate, productIdTag, expirationDate, customFields);
  }
  ...
  public String toString() {
    ...
    sb.append("    itemSerials: ").append(toIndentedString(itemSerials)).append("\n");
