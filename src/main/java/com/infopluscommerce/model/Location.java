...
public class Location {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, warehouseId, buildingId, zoneId, aisleId, billingTypeId, behaviorType, footprintId, addressSchemeId, origin, address, level, bay, number, online, priorityCode, cost, allowItemMixing, createDate, modifyDate, quantity, customFields);
  }
