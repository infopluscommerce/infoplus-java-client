...
public class OrderLineApi {
  ...
  public List<OrderLine> getOrderLineByFilter(String filter, Integer page, Integer limit, String sort) throws ApiException {
    ...
    String path = "/v1.0/orderLine/search".replaceAll("\\{format\\}","json");
    ...
    GenericType<List<OrderLine>> returnType = new GenericType<List<OrderLine>>() {};
   ...
   * @param orderLineId Id of the orderLine to be returned.
   * @return OrderLine
   */
  public OrderLine getOrderLineById(Integer orderLineId) throws ApiException {
    ...
    // create path and map variables
    String path = "/v1.0/orderLine/{orderLineId}".replaceAll("\\{format\\}","json")
    ...
    GenericType<OrderLine> returnType = new GenericType<OrderLine>() {};
    return apiClient.invokeAPI(path, "GET", queryParams, postBody, headerParams, formParams, accept, contentType, authNames, returnType);
