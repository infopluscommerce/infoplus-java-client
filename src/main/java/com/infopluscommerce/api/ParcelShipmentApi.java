...
public class ParcelShipmentApi {
  ...
  public List<ParcelShipment> getParcelShipmentByFilter(String filter, Integer page, Integer limit, String sort) throws ApiException {
    ...
    String localVarPath = "/beta/parcelShipment/search".replaceAll("\\{format\\}","json");
    ...
    GenericType<List<ParcelShipment>> localVarReturnType = new GenericType<List<ParcelShipment>>() {};
   ...
   * @param parcelShipmentId Id of the parcelShipment to be returned. (required)
  ...
  public ParcelShipment getParcelShipmentById(Integer parcelShipmentId) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/beta/parcelShipment/{parcelShipmentId}".replaceAll("\\{format\\}","json")
  ...
  public void updateParcelShipmentCustomFields(ParcelShipment body) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/beta/parcelShipment/customFields".replaceAll("\\{format\\}","json");
