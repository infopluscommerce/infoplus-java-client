...
public class ItemActivityTypeApi {
  ...
  public ItemActivityType getItemActivityTypeById(String itemActivityTypeId) throws ApiException {
    ...
    if (itemActivityTypeId == null) {
      throw new ApiException(400, "Missing the required parameter 'itemActivityTypeId' when calling getItemActivityTypeById");
    }
    
    // create path and map variables
    String localVarPath = "/v2.0/itemActivityType/{itemActivityTypeId}".replaceAll("\\{format\\}","json")
    ...
    GenericType<ItemActivityType> localVarReturnType = new GenericType<ItemActivityType>() {};
  ...
  public List<ItemActivityType> getItemActivityTypeBySearchText(String searchText, Integer page, Integer limit) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/v2.0/itemActivityType/search".replaceAll("\\{format\\}","json");
    ...
    GenericType<List<ItemActivityType>> localVarReturnType = new GenericType<List<ItemActivityType>>() {};
    return apiClient.invokeAPI(localVarPath, "GET", localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
