...
public class UserApi {
  ...
  public List<User> getUserBySearchText(String searchText, Integer page, Integer limit) throws ApiException {
    ...
    String path = "/v1.0/user/search".replaceAll("\\{format\\}","json");
    ...
    GenericType<List<User>> returnType = new GenericType<List<User>>() {};
  ...
  public User getUserById(String userId) throws ApiException {
    ...
    // create path and map variables
    String path = "/v1.0/user/{userId}".replaceAll("\\{format\\}","json")
