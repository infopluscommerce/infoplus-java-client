...
public class ReplenishmentApi {
  ...
  public List<Replenishment> getReplenishmentByFilter(String filter, Integer page, Integer limit, String sort) throws ApiException {
    ...
    String path = "/v1.0/replenishment/search".replaceAll("\\{format\\}","json");
    ...
    GenericType<List<Replenishment>> returnType = new GenericType<List<Replenishment>>() {};
   ...
   * @param replenishmentId Id of the replenishment to be returned.
  ...
  public Replenishment getReplenishmentById(Integer replenishmentId) throws ApiException {
    ...
    // create path and map variables
    String path = "/v1.0/replenishment/{replenishmentId}".replaceAll("\\{format\\}","json")
    ...
    GenericType<Replenishment> returnType = new GenericType<Replenishment>() {};
    return apiClient.invokeAPI(path, "GET", queryParams, postBody, headerParams, formParams, accept, contentType, authNames, returnType);
