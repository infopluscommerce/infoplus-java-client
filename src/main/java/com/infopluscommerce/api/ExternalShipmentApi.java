...
import com.infopluscommerce.model.ExecuteExternalShipmentInputAPIModel;
...
public class ExternalShipmentApi {
    ...
    /**
     * Build call for executeExternalShipment
     * @param body Input data for ExecuteExternalShipment process. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call executeExternalShipmentCall(ExecuteExternalShipmentInputAPIModel body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;

        // create path and map variables
        String localVarPath = "/beta/externalShipment/executeExternalShipment";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call executeExternalShipmentValidateBeforeCall(ExecuteExternalShipmentInputAPIModel body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling executeExternalShipment(Async)");
        }
        

        com.squareup.okhttp.Call call = executeExternalShipmentCall(body, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<ProcessOutputAPIModel> executeExternalShipment(ExecuteExternalShipmentInputAPIModel body) throws ApiException {
        ApiResponse<List<ProcessOutputAPIModel>> resp = executeExternalShipmentWithHttpInfo(body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<ProcessOutputAPIModel>> executeExternalShipmentWithHttpInfo(ExecuteExternalShipmentInputAPIModel body) throws ApiException {
        com.squareup.okhttp.Call call = executeExternalShipmentValidateBeforeCall(body, null, null);
        Type localVarReturnType = new TypeToken<List<ProcessOutputAPIModel>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Run the ExecuteExternalShipment process. (asynchronously)
     * 
     * @param body Input data for ExecuteExternalShipment process. (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call executeExternalShipmentAsync(ExecuteExternalShipmentInputAPIModel body, final ApiCallback<List<ProcessOutputAPIModel>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = executeExternalShipmentValidateBeforeCall(body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<ProcessOutputAPIModel>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
