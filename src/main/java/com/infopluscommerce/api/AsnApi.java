...
import com.infopluscommerce.model.ClosePurchProcessInputAPIModel;
...
public class AsnApi {
    ...
    /**
     * Build call for closeAsn
     * @param body Input data for ClosePurchProcess process. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call closeAsnCall(ClosePurchProcessInputAPIModel body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;

        // create path and map variables
        String localVarPath = "/beta/asn/closeAsn";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call closeAsnValidateBeforeCall(ClosePurchProcessInputAPIModel body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling closeAsn(Async)");
        }
        

        com.squareup.okhttp.Call call = closeAsnCall(body, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<ProcessOutputAPIModel> closeAsn(ClosePurchProcessInputAPIModel body) throws ApiException {
        ApiResponse<List<ProcessOutputAPIModel>> resp = closeAsnWithHttpInfo(body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<ProcessOutputAPIModel>> closeAsnWithHttpInfo(ClosePurchProcessInputAPIModel body) throws ApiException {
        com.squareup.okhttp.Call call = closeAsnValidateBeforeCall(body, null, null);
        Type localVarReturnType = new TypeToken<List<ProcessOutputAPIModel>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Run the ClosePurchProcess process. (asynchronously)
     * 
     * @param body Input data for ClosePurchProcess process. (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call closeAsnAsync(ClosePurchProcessInputAPIModel body, final ApiCallback<List<ProcessOutputAPIModel>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = closeAsnValidateBeforeCall(body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<ProcessOutputAPIModel>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
