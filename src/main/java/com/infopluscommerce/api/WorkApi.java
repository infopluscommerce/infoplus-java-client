...
public class WorkApi {
  ...
  public List<Work> getWorkByFilter(String filter, Integer page, Integer limit, String sort) throws ApiException {
    ...
    String path = "/v1.0/work/search".replaceAll("\\{format\\}","json");
    ...
    GenericType<List<Work>> returnType = new GenericType<List<Work>>() {};
  ...
  public Work getWorkById(Integer workId) throws ApiException {
    ...
    // create path and map variables
    String path = "/v1.0/work/{workId}".replaceAll("\\{format\\}","json")
    ...
    GenericType<Work> returnType = new GenericType<Work>() {};
    return apiClient.invokeAPI(path, "GET", queryParams, postBody, headerParams, formParams, accept, contentType, authNames, returnType);
