...
public class ItemSerialApi {
    ...
    public com.squareup.okhttp.Call addItemSerialCall(ItemSerial body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/beta/itemSerial";
    ...
    public com.squareup.okhttp.Call addItemSerialFileCall(Integer itemSerialId, String fileName, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/beta/itemSerial/{itemSerialId}/file/{fileName}"
            .replaceAll("\\{" + "itemSerialId" + "\\}", apiClient.escapeString(itemSerialId.toString()))
    ...
    public com.squareup.okhttp.Call addItemSerialFileByURLCall(RecordFile body, Integer itemSerialId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/beta/itemSerial/{itemSerialId}/file"
            .replaceAll("\\{" + "itemSerialId" + "\\}", apiClient.escapeString(itemSerialId.toString()));
    ...
    public com.squareup.okhttp.Call deleteItemSerialFileCall(Integer itemSerialId, Integer fileId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/beta/itemSerial/{itemSerialId}/file/{fileId}"
            .replaceAll("\\{" + "itemSerialId" + "\\}", apiClient.escapeString(itemSerialId.toString()))
