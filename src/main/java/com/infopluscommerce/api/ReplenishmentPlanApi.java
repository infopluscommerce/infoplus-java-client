...
public class ReplenishmentPlanApi {
    ...
    public com.squareup.okhttp.Call addReplenishmentPlanFileCall(Integer replenishmentPlanId, String fileName, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/beta/replenishmentPlan/{replenishmentPlanId}/file/{fileName}"
            .replaceAll("\\{" + "replenishmentPlanId" + "\\}", apiClient.escapeString(replenishmentPlanId.toString()))
    ...
    public com.squareup.okhttp.Call addReplenishmentPlanFileByURLCall(RecordFile body, Integer replenishmentPlanId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/beta/replenishmentPlan/{replenishmentPlanId}/file"
            .replaceAll("\\{" + "replenishmentPlanId" + "\\}", apiClient.escapeString(replenishmentPlanId.toString()));
    ...
    public com.squareup.okhttp.Call deleteReplenishmentPlanFileCall(Integer replenishmentPlanId, Integer fileId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/beta/replenishmentPlan/{replenishmentPlanId}/file/{fileId}"
            .replaceAll("\\{" + "replenishmentPlanId" + "\\}", apiClient.escapeString(replenishmentPlanId.toString()))
