...
public class ZoneApi {
  ...
  public void updateZone(Zone body) throws ApiException {
    ...
    String path = "/v1.0/zone".replaceAll("\\{format\\}","json");
   ...
   * @param body Zone to be inserted.
   * @return Zone
   */
  public Zone addZone(Zone body) throws ApiException {
    ...
    GenericType<Zone> returnType = new GenericType<Zone>() {};
  ...
  public List<Zone> getZoneByFilter(String filter, Integer page, Integer limit, String sort) throws ApiException {
    ...
    // create path and map variables
    String path = "/v1.0/zone/search".replaceAll("\\{format\\}","json");
    ...
    GenericType<List<Zone>> returnType = new GenericType<List<Zone>>() {};
   ...
   * @param zoneId Id of the zone to be returned.
   * @return Zone
   */
  public Zone getZoneById(Integer zoneId) throws ApiException {
    ...
    // create path and map variables
    String path = "/v1.0/zone/{zoneId}".replaceAll("\\{format\\}","json")
