...
public class ItemSubCategoryApi {
    ...
    public com.squareup.okhttp.Call addItemSubCategoryFileCall(Integer itemSubCategoryId, String fileName, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/beta/itemSubCategory/{itemSubCategoryId}/file/{fileName}"
            .replaceAll("\\{" + "itemSubCategoryId" + "\\}", apiClient.escapeString(itemSubCategoryId.toString()))
    ...
    public com.squareup.okhttp.Call addItemSubCategoryFileByURLCall(RecordFile body, Integer itemSubCategoryId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/beta/itemSubCategory/{itemSubCategoryId}/file"
            .replaceAll("\\{" + "itemSubCategoryId" + "\\}", apiClient.escapeString(itemSubCategoryId.toString()));
    ...
    public com.squareup.okhttp.Call deleteItemSubCategoryFileCall(Integer itemSubCategoryId, Integer fileId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/beta/itemSubCategory/{itemSubCategoryId}/file/{fileId}"
            .replaceAll("\\{" + "itemSubCategoryId" + "\\}", apiClient.escapeString(itemSubCategoryId.toString()))
