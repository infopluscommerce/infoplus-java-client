...
public class QuickAdjustmentApi {
  ...
  public List<ProcessOutputAPIModel> executeQuickAdjustment(ExecuteQuickAdjustmentInputAPIModel body) throws ApiException {
    ...
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling executeQuickAdjustment");
    }
    
    // create path and map variables
    String localVarPath = "/beta/quickAdjustment/executeQuickAdjustment".replaceAll("\\{format\\}","json");
