...
public class PredefinedCartonApi {
  ...
  public PredefinedCarton getPredefinedCartonById(String predefinedCartonId) throws ApiException {
    ...
    if (predefinedCartonId == null) {
      throw new ApiException(400, "Missing the required parameter 'predefinedCartonId' when calling getPredefinedCartonById");
    }
    
    // create path and map variables
    String localVarPath = "/beta/predefinedCarton/{predefinedCartonId}".replaceAll("\\{format\\}","json")
    ...
    GenericType<PredefinedCarton> localVarReturnType = new GenericType<PredefinedCarton>() {};
  ...
  public List<PredefinedCarton> getPredefinedCartonBySearchText(String searchText, Integer page, Integer limit) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/beta/predefinedCarton/search".replaceAll("\\{format\\}","json");
    ...
    GenericType<List<PredefinedCarton>> localVarReturnType = new GenericType<List<PredefinedCarton>>() {};
    return apiClient.invokeAPI(localVarPath, "GET", localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
