...
public class WarehouseApi {
   ...
   * @param body Warehouse to be updated.
   * @return void
   */
  public void updateWarehouse(Warehouse body) throws ApiException {
    ...
    String path = "/v1.0/warehouse".replaceAll("\\{format\\}","json");
  ...
  public List<Warehouse> getWarehouseByFilter(String filter, Integer page, Integer limit, String sort) throws ApiException {
    ...
    // create path and map variables
    String path = "/v1.0/warehouse/search".replaceAll("\\{format\\}","json");
    ...
    GenericType<List<Warehouse>> returnType = new GenericType<List<Warehouse>>() {};
  ...
  public Warehouse getWarehouseById(Integer warehouseId) throws ApiException {
    ...
    // create path and map variables
    String path = "/v1.0/warehouse/{warehouseId}".replaceAll("\\{format\\}","json")
    ...
    GenericType<Warehouse> returnType = new GenericType<Warehouse>() {};
    return apiClient.invokeAPI(path, "GET", queryParams, postBody, headerParams, formParams, accept, contentType, authNames, returnType);
