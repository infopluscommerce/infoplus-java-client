...
public class BillingCodeActivityApi {
  ...
  public BillingCodeActivity addBillingCodeActivity(BillingCodeActivity body) throws ApiException {
    ...
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling addBillingCodeActivity");
    }
    
    // create path and map variables
    String localVarPath = "/beta/billingCodeActivity".replaceAll("\\{format\\}","json");
    ...
    GenericType<BillingCodeActivity> localVarReturnType = new GenericType<BillingCodeActivity>() {};
  ...
  public void addBillingCodeActivityAudit(Integer billingCodeActivityId, String billingCodeActivityAudit) throws ApiException {
    ...
    if (billingCodeActivityId == null) {
      throw new ApiException(400, "Missing the required parameter 'billingCodeActivityId' when calling addBillingCodeActivityAudit");
    }
    
    // verify the required parameter 'billingCodeActivityAudit' is set
    if (billingCodeActivityAudit == null) {
      throw new ApiException(400, "Missing the required parameter 'billingCodeActivityAudit' when calling addBillingCodeActivityAudit");
    }
    
    // create path and map variables
    String localVarPath = "/beta/billingCodeActivity/{billingCodeActivityId}/audit/{billingCodeActivityAudit}".replaceAll("\\{format\\}","json")
  ...
  public void addBillingCodeActivityTag(Integer billingCodeActivityId, String billingCodeActivityTag) throws ApiException {
    ...
    // verify the required parameter 'billingCodeActivityId' is set
    if (billingCodeActivityId == null) {
      throw new ApiException(400, "Missing the required parameter 'billingCodeActivityId' when calling addBillingCodeActivityTag");
    }
    
    // verify the required parameter 'billingCodeActivityTag' is set
    if (billingCodeActivityTag == null) {
      throw new ApiException(400, "Missing the required parameter 'billingCodeActivityTag' when calling addBillingCodeActivityTag");
    }
    
    // create path and map variables
    String localVarPath = "/beta/billingCodeActivity/{billingCodeActivityId}/tag/{billingCodeActivityTag}".replaceAll("\\{format\\}","json")
      .replaceAll("\\{" + "billingCodeActivityId" + "\\}", apiClient.escapeString(billingCodeActivityId.toString()))
  ...
  public void deleteBillingCodeActivity(Integer billingCodeActivityId) throws ApiException {
    ...
    // verify the required parameter 'billingCodeActivityId' is set
    if (billingCodeActivityId == null) {
      throw new ApiException(400, "Missing the required parameter 'billingCodeActivityId' when calling deleteBillingCodeActivity");
    }
    
    // create path and map variables
    String localVarPath = "/beta/billingCodeActivity/{billingCodeActivityId}".replaceAll("\\{format\\}","json")
      .replaceAll("\\{" + "billingCodeActivityId" + "\\}", apiClient.escapeString(billingCodeActivityId.toString()));
  ...
  public void deleteBillingCodeActivityTag(Integer billingCodeActivityId, String billingCodeActivityTag) throws ApiException {
    ...
    // verify the required parameter 'billingCodeActivityId' is set
    if (billingCodeActivityId == null) {
      throw new ApiException(400, "Missing the required parameter 'billingCodeActivityId' when calling deleteBillingCodeActivityTag");
    }
    
    // verify the required parameter 'billingCodeActivityTag' is set
    if (billingCodeActivityTag == null) {
      throw new ApiException(400, "Missing the required parameter 'billingCodeActivityTag' when calling deleteBillingCodeActivityTag");
    }
  ...
  public List<BillingCodeActivity> getBillingCodeActivityByFilter(String filter, Integer page, Integer limit, String sort) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/beta/billingCodeActivity/search".replaceAll("\\{format\\}","json");
    ...
    GenericType<List<BillingCodeActivity>> localVarReturnType = new GenericType<List<BillingCodeActivity>>() {};
  ...
  public BillingCodeActivity getBillingCodeActivityById(Integer billingCodeActivityId) throws ApiException {
    ...
    // verify the required parameter 'billingCodeActivityId' is set
    if (billingCodeActivityId == null) {
      throw new ApiException(400, "Missing the required parameter 'billingCodeActivityId' when calling getBillingCodeActivityById");
    }
  ...
  public void getBillingCodeActivityTags(Integer billingCodeActivityId) throws ApiException {
    ...
    // verify the required parameter 'billingCodeActivityId' is set
    if (billingCodeActivityId == null) {
      throw new ApiException(400, "Missing the required parameter 'billingCodeActivityId' when calling getBillingCodeActivityTags");
    }
    
    // create path and map variables
    String localVarPath = "/beta/billingCodeActivity/{billingCodeActivityId}/tag".replaceAll("\\{format\\}","json")
      .replaceAll("\\{" + "billingCodeActivityId" + "\\}", apiClient.escapeString(billingCodeActivityId.toString()));
  ...
  public BillingCodeActivity getDuplicateBillingCodeActivityById(Integer billingCodeActivityId) throws ApiException {
    ...
    // verify the required parameter 'billingCodeActivityId' is set
    if (billingCodeActivityId == null) {
      throw new ApiException(400, "Missing the required parameter 'billingCodeActivityId' when calling getDuplicateBillingCodeActivityById");
    }
    
    // create path and map variables
    String localVarPath = "/beta/billingCodeActivity/duplicate/{billingCodeActivityId}".replaceAll("\\{format\\}","json")
      .replaceAll("\\{" + "billingCodeActivityId" + "\\}", apiClient.escapeString(billingCodeActivityId.toString()));
  ...
  public void updateBillingCodeActivity(BillingCodeActivity body) throws ApiException {
    ...
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling updateBillingCodeActivity");
    }
