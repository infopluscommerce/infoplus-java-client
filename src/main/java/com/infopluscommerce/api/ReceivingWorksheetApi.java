...
public class ReceivingWorksheetApi {
   ...
   * @param body ReceivingWorksheet to be updated.
   * @return void
   */
  public void updateReceivingWorksheet(ReceivingWorksheet body) throws ApiException {
    ...
    String path = "/v1.0/receivingWorksheet".replaceAll("\\{format\\}","json");
   ...
   * @param body ReceivingWorksheet to be inserted.
  ...
  public ReceivingWorksheet addReceivingWorksheet(ReceivingWorksheet body) throws ApiException {
    ...
    GenericType<ReceivingWorksheet> returnType = new GenericType<ReceivingWorksheet>() {};
  ...
  public List<ReceivingWorksheet> getReceivingWorksheetByFilter(String filter, Integer page, Integer limit, String sort) throws ApiException {
    ...
    // create path and map variables
    String path = "/v1.0/receivingWorksheet/search".replaceAll("\\{format\\}","json");
    ...
    GenericType<List<ReceivingWorksheet>> returnType = new GenericType<List<ReceivingWorksheet>>() {};
   ...
   * @param receivingWorksheetId Id of the receivingWorksheet to be returned.
   * @return ReceivingWorksheet
   */
  public ReceivingWorksheet getReceivingWorksheetById(Integer receivingWorksheetId) throws ApiException {
    ...
    // create path and map variables
    String path = "/v1.0/receivingWorksheet/{receivingWorksheetId}".replaceAll("\\{format\\}","json")
   ...
   * @param receivingWorksheetId Id of the receivingWorksheet to be deleted.
   * @return void
   */
