...
*AsnApi* | [**closeAsn**](docs/AsnApi.md#closeAsn) | **POST** /beta/asn/closeAsn | Run the ClosePurchProcess process.
...
*CarrierCompanyCodeApi* | [**getCarrierCompanyCodeById**](docs/CarrierCompanyCodeApi.md#getCarrierCompanyCodeById) | **GET** /beta/carrierCompanyCode/{carrierCompanyCodeId} | Get a carrierCompanyCode by id
*CarrierCompanyCodeApi* | [**getCarrierCompanyCodeBySearchText**](docs/CarrierCompanyCodeApi.md#getCarrierCompanyCodeBySearchText) | **GET** /beta/carrierCompanyCode/search | Search carrierCompanyCodes
...
*DasFeeTypeApi* | [**getDASFeeTypeById**](docs/DasFeeTypeApi.md#getDASFeeTypeById) | **GET** /beta/dasFeeType/{dasFeeTypeId} | Get a dasFeeType by id
*DasFeeTypeApi* | [**getDasFeeTypeBySearchText**](docs/DasFeeTypeApi.md#getDasFeeTypeBySearchText) | **GET** /beta/dasFeeType/search | Search dasFeeTypes
*DasFeesApi* | [**addDasFees**](docs/DasFeesApi.md#addDasFees) | **POST** /beta/dasFees | Create a dasFees
*DasFeesApi* | [**addDasFeesAudit**](docs/DasFeesApi.md#addDasFeesAudit) | **PUT** /beta/dasFees/{dasFeesId}/audit/{dasFeesAudit} | Add new audit for a dasFees
*DasFeesApi* | [**addDasFeesFile**](docs/DasFeesApi.md#addDasFeesFile) | **POST** /beta/dasFees/{dasFeesId}/file/{fileName} | Attach a file to a dasFees
*DasFeesApi* | [**addDasFeesFileByURL**](docs/DasFeesApi.md#addDasFeesFileByURL) | **POST** /beta/dasFees/{dasFeesId}/file | Attach a file to a dasFees by URL.
*DasFeesApi* | [**addDasFeesTag**](docs/DasFeesApi.md#addDasFeesTag) | **PUT** /beta/dasFees/{dasFeesId}/tag/{dasFeesTag} | Add new tags for a dasFees.
*DasFeesApi* | [**deleteDasFees**](docs/DasFeesApi.md#deleteDasFees) | **DELETE** /beta/dasFees/{dasFeesId} | Delete a dasFees
*DasFeesApi* | [**deleteDasFeesFile**](docs/DasFeesApi.md#deleteDasFeesFile) | **DELETE** /beta/dasFees/{dasFeesId}/file/{fileId} | Delete a file for a dasFees.
*DasFeesApi* | [**deleteDasFeesTag**](docs/DasFeesApi.md#deleteDasFeesTag) | **DELETE** /beta/dasFees/{dasFeesId}/tag/{dasFeesTag} | Delete a tag for a dasFees.
*DasFeesApi* | [**getDasFeesByFilter**](docs/DasFeesApi.md#getDasFeesByFilter) | **GET** /beta/dasFees/search | Search dasFeeses by filter
*DasFeesApi* | [**getDasFeesById**](docs/DasFeesApi.md#getDasFeesById) | **GET** /beta/dasFees/{dasFeesId} | Get a dasFees by id
*DasFeesApi* | [**getDasFeesFiles**](docs/DasFeesApi.md#getDasFeesFiles) | **GET** /beta/dasFees/{dasFeesId}/file | Get the files for a dasFees.
*DasFeesApi* | [**getDasFeesTags**](docs/DasFeesApi.md#getDasFeesTags) | **GET** /beta/dasFees/{dasFeesId}/tag | Get the tags for a dasFees.
*DasFeesApi* | [**getDuplicateDasFeesById**](docs/DasFeesApi.md#getDuplicateDasFeesById) | **GET** /beta/dasFees/duplicate/{dasFeesId} | Get a duplicated a dasFees by id
*DasFeesApi* | [**updateDasFees**](docs/DasFeesApi.md#updateDasFees) | **PUT** /beta/dasFees | Update a dasFees
*DropshipApi* | [**addDropshipAudit**](docs/DropshipApi.md#addDropshipAudit) | **PUT** /beta/dropship/{dropshipId}/audit/{dropshipAudit} | Add new audit for a dropship
*DropshipApi* | [**addDropshipFile**](docs/DropshipApi.md#addDropshipFile) | **POST** /beta/dropship/{dropshipId}/file/{fileName} | Attach a file to a dropship
*DropshipApi* | [**addDropshipFileByURL**](docs/DropshipApi.md#addDropshipFileByURL) | **POST** /beta/dropship/{dropshipId}/file | Attach a file to a dropship by URL.
*DropshipApi* | [**addDropshipTag**](docs/DropshipApi.md#addDropshipTag) | **PUT** /beta/dropship/{dropshipId}/tag/{dropshipTag} | Add new tags for a dropship.
*DropshipApi* | [**deleteDropshipFile**](docs/DropshipApi.md#deleteDropshipFile) | **DELETE** /beta/dropship/{dropshipId}/file/{fileId} | Delete a file for a dropship.
*DropshipApi* | [**deleteDropshipTag**](docs/DropshipApi.md#deleteDropshipTag) | **DELETE** /beta/dropship/{dropshipId}/tag/{dropshipTag} | Delete a tag for a dropship.
*DropshipApi* | [**getDropshipByFilter**](docs/DropshipApi.md#getDropshipByFilter) | **GET** /beta/dropship/search | Search dropships by filter
*DropshipApi* | [**getDropshipById**](docs/DropshipApi.md#getDropshipById) | **GET** /beta/dropship/{dropshipId} | Get a dropship by id
*DropshipApi* | [**getDropshipFiles**](docs/DropshipApi.md#getDropshipFiles) | **GET** /beta/dropship/{dropshipId}/file | Get the files for a dropship.
*DropshipApi* | [**getDropshipTags**](docs/DropshipApi.md#getDropshipTags) | **GET** /beta/dropship/{dropshipId}/tag | Get the tags for a dropship.
*DropshipApi* | [**getDuplicateDropshipById**](docs/DropshipApi.md#getDuplicateDropshipById) | **GET** /beta/dropship/duplicate/{dropshipId} | Get a duplicated a dropship by id
*DropshipApi* | [**updateDropship**](docs/DropshipApi.md#updateDropship) | **PUT** /beta/dropship | Update a dropship
...
*ProductChargesApi* | [**addProductCharges**](docs/ProductChargesApi.md#addProductCharges) | **POST** /beta/productCharges | Create a productCharges
*ProductChargesApi* | [**addProductChargesAudit**](docs/ProductChargesApi.md#addProductChargesAudit) | **PUT** /beta/productCharges/{productChargesId}/audit/{productChargesAudit} | Add new audit for a productCharges
*ProductChargesApi* | [**addProductChargesFile**](docs/ProductChargesApi.md#addProductChargesFile) | **POST** /beta/productCharges/{productChargesId}/file/{fileName} | Attach a file to a productCharges
*ProductChargesApi* | [**addProductChargesFileByURL**](docs/ProductChargesApi.md#addProductChargesFileByURL) | **POST** /beta/productCharges/{productChargesId}/file | Attach a file to a productCharges by URL.
*ProductChargesApi* | [**addProductChargesTag**](docs/ProductChargesApi.md#addProductChargesTag) | **PUT** /beta/productCharges/{productChargesId}/tag/{productChargesTag} | Add new tags for a productCharges.
*ProductChargesApi* | [**deleteProductCharges**](docs/ProductChargesApi.md#deleteProductCharges) | **DELETE** /beta/productCharges/{productChargesId} | Delete a productCharges
*ProductChargesApi* | [**deleteProductChargesFile**](docs/ProductChargesApi.md#deleteProductChargesFile) | **DELETE** /beta/productCharges/{productChargesId}/file/{fileId} | Delete a file for a productCharges.
*ProductChargesApi* | [**deleteProductChargesTag**](docs/ProductChargesApi.md#deleteProductChargesTag) | **DELETE** /beta/productCharges/{productChargesId}/tag/{productChargesTag} | Delete a tag for a productCharges.
*ProductChargesApi* | [**getDuplicateProductChargesById**](docs/ProductChargesApi.md#getDuplicateProductChargesById) | **GET** /beta/productCharges/duplicate/{productChargesId} | Get a duplicated a productCharges by id
*ProductChargesApi* | [**getProductChargesByFilter**](docs/ProductChargesApi.md#getProductChargesByFilter) | **GET** /beta/productCharges/search | Search productChargeses by filter
*ProductChargesApi* | [**getProductChargesById**](docs/ProductChargesApi.md#getProductChargesById) | **GET** /beta/productCharges/{productChargesId} | Get a productCharges by id
*ProductChargesApi* | [**getProductChargesFiles**](docs/ProductChargesApi.md#getProductChargesFiles) | **GET** /beta/productCharges/{productChargesId}/file | Get the files for a productCharges.
*ProductChargesApi* | [**getProductChargesTags**](docs/ProductChargesApi.md#getProductChargesTags) | **GET** /beta/productCharges/{productChargesId}/tag | Get the tags for a productCharges.
*ProductChargesApi* | [**updateProductCharges**](docs/ProductChargesApi.md#updateProductCharges) | **PUT** /beta/productCharges | Update a productCharges
...
*RateCardApi* | [**addRateCard**](docs/RateCardApi.md#addRateCard) | **POST** /beta/rateCard | Create a rateCard
*RateCardApi* | [**addRateCardAudit**](docs/RateCardApi.md#addRateCardAudit) | **PUT** /beta/rateCard/{rateCardId}/audit/{rateCardAudit} | Add new audit for a rateCard
*RateCardApi* | [**addRateCardFile**](docs/RateCardApi.md#addRateCardFile) | **POST** /beta/rateCard/{rateCardId}/file/{fileName} | Attach a file to a rateCard
*RateCardApi* | [**addRateCardFileByURL**](docs/RateCardApi.md#addRateCardFileByURL) | **POST** /beta/rateCard/{rateCardId}/file | Attach a file to a rateCard by URL.
*RateCardApi* | [**addRateCardTag**](docs/RateCardApi.md#addRateCardTag) | **PUT** /beta/rateCard/{rateCardId}/tag/{rateCardTag} | Add new tags for a rateCard.
*RateCardApi* | [**deleteRateCard**](docs/RateCardApi.md#deleteRateCard) | **DELETE** /beta/rateCard/{rateCardId} | Delete a rateCard
*RateCardApi* | [**deleteRateCardFile**](docs/RateCardApi.md#deleteRateCardFile) | **DELETE** /beta/rateCard/{rateCardId}/file/{fileId} | Delete a file for a rateCard.
*RateCardApi* | [**deleteRateCardTag**](docs/RateCardApi.md#deleteRateCardTag) | **DELETE** /beta/rateCard/{rateCardId}/tag/{rateCardTag} | Delete a tag for a rateCard.
*RateCardApi* | [**getDuplicateRateCardById**](docs/RateCardApi.md#getDuplicateRateCardById) | **GET** /beta/rateCard/duplicate/{rateCardId} | Get a duplicated a rateCard by id
*RateCardApi* | [**getRateCardByFilter**](docs/RateCardApi.md#getRateCardByFilter) | **GET** /beta/rateCard/search | Search rateCards by filter
*RateCardApi* | [**getRateCardById**](docs/RateCardApi.md#getRateCardById) | **GET** /beta/rateCard/{rateCardId} | Get a rateCard by id
*RateCardApi* | [**getRateCardFiles**](docs/RateCardApi.md#getRateCardFiles) | **GET** /beta/rateCard/{rateCardId}/file | Get the files for a rateCard.
*RateCardApi* | [**getRateCardTags**](docs/RateCardApi.md#getRateCardTags) | **GET** /beta/rateCard/{rateCardId}/tag | Get the tags for a rateCard.
*RateCardApi* | [**updateRateCard**](docs/RateCardApi.md#updateRateCard) | **PUT** /beta/rateCard | Update a rateCard
*RateTypeApi* | [**getRateTypeById**](docs/RateTypeApi.md#getRateTypeById) | **GET** /beta/rateType/{rateTypeId} | Get a rateType by id
*RateTypeApi* | [**getRateTypeBySearchText**](docs/RateTypeApi.md#getRateTypeBySearchText) | **GET** /beta/rateType/search | Search rateTypes
...
*ReturnOrderApi* | [**addReturnOrderAudit**](docs/ReturnOrderApi.md#addReturnOrderAudit) | **PUT** /beta/returnOrder/{returnOrderId}/audit/{returnOrderAudit} | Add new audit for a returnOrder
*ReturnOrderApi* | [**addReturnOrderFile**](docs/ReturnOrderApi.md#addReturnOrderFile) | **POST** /beta/returnOrder/{returnOrderId}/file/{fileName} | Attach a file to a returnOrder
*ReturnOrderApi* | [**addReturnOrderFileByURL**](docs/ReturnOrderApi.md#addReturnOrderFileByURL) | **POST** /beta/returnOrder/{returnOrderId}/file | Attach a file to a returnOrder by URL.
*ReturnOrderApi* | [**addReturnOrderTag**](docs/ReturnOrderApi.md#addReturnOrderTag) | **PUT** /beta/returnOrder/{returnOrderId}/tag/{returnOrderTag} | Add new tags for a returnOrder.
*ReturnOrderApi* | [**deleteReturnOrderFile**](docs/ReturnOrderApi.md#deleteReturnOrderFile) | **DELETE** /beta/returnOrder/{returnOrderId}/file/{fileId} | Delete a file for a returnOrder.
*ReturnOrderApi* | [**deleteReturnOrderTag**](docs/ReturnOrderApi.md#deleteReturnOrderTag) | **DELETE** /beta/returnOrder/{returnOrderId}/tag/{returnOrderTag} | Delete a tag for a returnOrder.
*ReturnOrderApi* | [**getDuplicateReturnOrderById**](docs/ReturnOrderApi.md#getDuplicateReturnOrderById) | **GET** /beta/returnOrder/duplicate/{returnOrderId} | Get a duplicated a returnOrder by id
*ReturnOrderApi* | [**getReturnOrderByFilter**](docs/ReturnOrderApi.md#getReturnOrderByFilter) | **GET** /beta/returnOrder/search | Search returnOrders by filter
*ReturnOrderApi* | [**getReturnOrderById**](docs/ReturnOrderApi.md#getReturnOrderById) | **GET** /beta/returnOrder/{returnOrderId} | Get a returnOrder by id
*ReturnOrderApi* | [**getReturnOrderFiles**](docs/ReturnOrderApi.md#getReturnOrderFiles) | **GET** /beta/returnOrder/{returnOrderId}/file | Get the files for a returnOrder.
*ReturnOrderApi* | [**getReturnOrderTags**](docs/ReturnOrderApi.md#getReturnOrderTags) | **GET** /beta/returnOrder/{returnOrderId}/tag | Get the tags for a returnOrder.
*ReturnOrderApi* | [**updateReturnOrder**](docs/ReturnOrderApi.md#updateReturnOrder) | **PUT** /beta/returnOrder | Update a returnOrder
*ReturnOrderApi* | [**updateReturnOrderCustomFields**](docs/ReturnOrderApi.md#updateReturnOrderCustomFields) | **PUT** /beta/returnOrder/customFields | Update a returnOrder custom fields
*ReturnOrderLineApi* | [**addReturnOrderLineAudit**](docs/ReturnOrderLineApi.md#addReturnOrderLineAudit) | **PUT** /beta/returnOrderLine/{returnOrderLineId}/audit/{returnOrderLineAudit} | Add new audit for a returnOrderLine
*ReturnOrderLineApi* | [**addReturnOrderLineFile**](docs/ReturnOrderLineApi.md#addReturnOrderLineFile) | **POST** /beta/returnOrderLine/{returnOrderLineId}/file/{fileName} | Attach a file to a returnOrderLine
*ReturnOrderLineApi* | [**addReturnOrderLineFileByURL**](docs/ReturnOrderLineApi.md#addReturnOrderLineFileByURL) | **POST** /beta/returnOrderLine/{returnOrderLineId}/file | Attach a file to a returnOrderLine by URL.
*ReturnOrderLineApi* | [**addReturnOrderLineTag**](docs/ReturnOrderLineApi.md#addReturnOrderLineTag) | **PUT** /beta/returnOrderLine/{returnOrderLineId}/tag/{returnOrderLineTag} | Add new tags for a returnOrderLine.
*ReturnOrderLineApi* | [**deleteReturnOrderLineFile**](docs/ReturnOrderLineApi.md#deleteReturnOrderLineFile) | **DELETE** /beta/returnOrderLine/{returnOrderLineId}/file/{fileId} | Delete a file for a returnOrderLine.
*ReturnOrderLineApi* | [**deleteReturnOrderLineTag**](docs/ReturnOrderLineApi.md#deleteReturnOrderLineTag) | **DELETE** /beta/returnOrderLine/{returnOrderLineId}/tag/{returnOrderLineTag} | Delete a tag for a returnOrderLine.
*ReturnOrderLineApi* | [**getDuplicateReturnOrderLineById**](docs/ReturnOrderLineApi.md#getDuplicateReturnOrderLineById) | **GET** /beta/returnOrderLine/duplicate/{returnOrderLineId} | Get a duplicated a returnOrderLine by id
*ReturnOrderLineApi* | [**getReturnOrderLineByFilter**](docs/ReturnOrderLineApi.md#getReturnOrderLineByFilter) | **GET** /beta/returnOrderLine/search | Search returnOrderLines by filter
*ReturnOrderLineApi* | [**getReturnOrderLineById**](docs/ReturnOrderLineApi.md#getReturnOrderLineById) | **GET** /beta/returnOrderLine/{returnOrderLineId} | Get a returnOrderLine by id
*ReturnOrderLineApi* | [**getReturnOrderLineFiles**](docs/ReturnOrderLineApi.md#getReturnOrderLineFiles) | **GET** /beta/returnOrderLine/{returnOrderLineId}/file | Get the files for a returnOrderLine.
*ReturnOrderLineApi* | [**getReturnOrderLineTags**](docs/ReturnOrderLineApi.md#getReturnOrderLineTags) | **GET** /beta/returnOrderLine/{returnOrderLineId}/tag | Get the tags for a returnOrderLine.
*ReturnOrderLineApi* | [**updateReturnOrderLineCustomFields**](docs/ReturnOrderLineApi.md#updateReturnOrderLineCustomFields) | **PUT** /beta/returnOrderLine/customFields | Update a returnOrderLine custom fields
*ReturnOrderLineDetailsApi* | [**addReturnOrderLineDetailsAudit**](docs/ReturnOrderLineDetailsApi.md#addReturnOrderLineDetailsAudit) | **PUT** /beta/returnOrderLineDetails/{returnOrderLineDetailsId}/audit/{returnOrderLineDetailsAudit} | Add new audit for a returnOrderLineDetails
*ReturnOrderLineDetailsApi* | [**addReturnOrderLineDetailsFile**](docs/ReturnOrderLineDetailsApi.md#addReturnOrderLineDetailsFile) | **POST** /beta/returnOrderLineDetails/{returnOrderLineDetailsId}/file/{fileName} | Attach a file to a returnOrderLineDetails
*ReturnOrderLineDetailsApi* | [**addReturnOrderLineDetailsFileByURL**](docs/ReturnOrderLineDetailsApi.md#addReturnOrderLineDetailsFileByURL) | **POST** /beta/returnOrderLineDetails/{returnOrderLineDetailsId}/file | Attach a file to a returnOrderLineDetails by URL.
*ReturnOrderLineDetailsApi* | [**addReturnOrderLineDetailsTag**](docs/ReturnOrderLineDetailsApi.md#addReturnOrderLineDetailsTag) | **PUT** /beta/returnOrderLineDetails/{returnOrderLineDetailsId}/tag/{returnOrderLineDetailsTag} | Add new tags for a returnOrderLineDetails.
*ReturnOrderLineDetailsApi* | [**deleteReturnOrderLineDetailsFile**](docs/ReturnOrderLineDetailsApi.md#deleteReturnOrderLineDetailsFile) | **DELETE** /beta/returnOrderLineDetails/{returnOrderLineDetailsId}/file/{fileId} | Delete a file for a returnOrderLineDetails.
*ReturnOrderLineDetailsApi* | [**deleteReturnOrderLineDetailsTag**](docs/ReturnOrderLineDetailsApi.md#deleteReturnOrderLineDetailsTag) | **DELETE** /beta/returnOrderLineDetails/{returnOrderLineDetailsId}/tag/{returnOrderLineDetailsTag} | Delete a tag for a returnOrderLineDetails.
*ReturnOrderLineDetailsApi* | [**getDuplicateReturnOrderLineDetailsById**](docs/ReturnOrderLineDetailsApi.md#getDuplicateReturnOrderLineDetailsById) | **GET** /beta/returnOrderLineDetails/duplicate/{returnOrderLineDetailsId} | Get a duplicated a returnOrderLineDetails by id
*ReturnOrderLineDetailsApi* | [**getReturnOrderLineDetailsByFilter**](docs/ReturnOrderLineDetailsApi.md#getReturnOrderLineDetailsByFilter) | **GET** /beta/returnOrderLineDetails/search | Search returnOrderLineDetailses by filter
*ReturnOrderLineDetailsApi* | [**getReturnOrderLineDetailsById**](docs/ReturnOrderLineDetailsApi.md#getReturnOrderLineDetailsById) | **GET** /beta/returnOrderLineDetails/{returnOrderLineDetailsId} | Get a returnOrderLineDetails by id
*ReturnOrderLineDetailsApi* | [**getReturnOrderLineDetailsFiles**](docs/ReturnOrderLineDetailsApi.md#getReturnOrderLineDetailsFiles) | **GET** /beta/returnOrderLineDetails/{returnOrderLineDetailsId}/file | Get the files for a returnOrderLineDetails.
*ReturnOrderLineDetailsApi* | [**getReturnOrderLineDetailsTags**](docs/ReturnOrderLineDetailsApi.md#getReturnOrderLineDetailsTags) | **GET** /beta/returnOrderLineDetails/{returnOrderLineDetailsId}/tag | Get the tags for a returnOrderLineDetails.
*ReturnOrderLineDetailsApi* | [**updateReturnOrderLineDetailsCustomFields**](docs/ReturnOrderLineDetailsApi.md#updateReturnOrderLineDetailsCustomFields) | **PUT** /beta/returnOrderLineDetails/customFields | Update a returnOrderLineDetails custom fields
...
*UspsHazmatTypeApi* | [**getUSPSHazmatTypeById**](docs/UspsHazmatTypeApi.md#getUSPSHazmatTypeById) | **GET** /beta/uspsHazmatType/{uspsHazmatTypeId} | Get an uspsHazmatType by id
*UspsHazmatTypeApi* | [**getUspsHazmatTypeBySearchText**](docs/UspsHazmatTypeApi.md#getUspsHazmatTypeBySearchText) | **GET** /beta/uspsHazmatType/search | Search uspsHazmatTypes
...
*ZipCodeZoneApi* | [**addZipCodeZone**](docs/ZipCodeZoneApi.md#addZipCodeZone) | **POST** /beta/zipCodeZone | Create a zipCodeZone
*ZipCodeZoneApi* | [**addZipCodeZoneAudit**](docs/ZipCodeZoneApi.md#addZipCodeZoneAudit) | **PUT** /beta/zipCodeZone/{zipCodeZoneId}/audit/{zipCodeZoneAudit} | Add new audit for a zipCodeZone
*ZipCodeZoneApi* | [**addZipCodeZoneFile**](docs/ZipCodeZoneApi.md#addZipCodeZoneFile) | **POST** /beta/zipCodeZone/{zipCodeZoneId}/file/{fileName} | Attach a file to a zipCodeZone
*ZipCodeZoneApi* | [**addZipCodeZoneFileByURL**](docs/ZipCodeZoneApi.md#addZipCodeZoneFileByURL) | **POST** /beta/zipCodeZone/{zipCodeZoneId}/file | Attach a file to a zipCodeZone by URL.
*ZipCodeZoneApi* | [**addZipCodeZoneTag**](docs/ZipCodeZoneApi.md#addZipCodeZoneTag) | **PUT** /beta/zipCodeZone/{zipCodeZoneId}/tag/{zipCodeZoneTag} | Add new tags for a zipCodeZone.
*ZipCodeZoneApi* | [**deleteZipCodeZone**](docs/ZipCodeZoneApi.md#deleteZipCodeZone) | **DELETE** /beta/zipCodeZone/{zipCodeZoneId} | Delete a zipCodeZone
*ZipCodeZoneApi* | [**deleteZipCodeZoneFile**](docs/ZipCodeZoneApi.md#deleteZipCodeZoneFile) | **DELETE** /beta/zipCodeZone/{zipCodeZoneId}/file/{fileId} | Delete a file for a zipCodeZone.
*ZipCodeZoneApi* | [**deleteZipCodeZoneTag**](docs/ZipCodeZoneApi.md#deleteZipCodeZoneTag) | **DELETE** /beta/zipCodeZone/{zipCodeZoneId}/tag/{zipCodeZoneTag} | Delete a tag for a zipCodeZone.
*ZipCodeZoneApi* | [**getDuplicateZipCodeZoneById**](docs/ZipCodeZoneApi.md#getDuplicateZipCodeZoneById) | **GET** /beta/zipCodeZone/duplicate/{zipCodeZoneId} | Get a duplicated a zipCodeZone by id
*ZipCodeZoneApi* | [**getZipCodeZoneByFilter**](docs/ZipCodeZoneApi.md#getZipCodeZoneByFilter) | **GET** /beta/zipCodeZone/search | Search zipCodeZones by filter
*ZipCodeZoneApi* | [**getZipCodeZoneById**](docs/ZipCodeZoneApi.md#getZipCodeZoneById) | **GET** /beta/zipCodeZone/{zipCodeZoneId} | Get a zipCodeZone by id
*ZipCodeZoneApi* | [**getZipCodeZoneFiles**](docs/ZipCodeZoneApi.md#getZipCodeZoneFiles) | **GET** /beta/zipCodeZone/{zipCodeZoneId}/file | Get the files for a zipCodeZone.
*ZipCodeZoneApi* | [**getZipCodeZoneTags**](docs/ZipCodeZoneApi.md#getZipCodeZoneTags) | **GET** /beta/zipCodeZone/{zipCodeZoneId}/tag | Get the tags for a zipCodeZone.
*ZipCodeZoneApi* | [**updateZipCodeZone**](docs/ZipCodeZoneApi.md#updateZipCodeZone) | **PUT** /beta/zipCodeZone | Update a zipCodeZone
...
## Documentation for Models
 ...
 - [CarrierCompanyCode](docs/CarrierCompanyCode.md)
 ...
 - [ClosePurchProcessInputAPIModel](docs/ClosePurchProcessInputAPIModel.md)
 ...
 - [DasFeeType](docs/DasFeeType.md)
 - [DasFees](docs/DasFees.md)
 - [Dropship](docs/Dropship.md)
 ...
 - [ProductCharges](docs/ProductCharges.md)
 ...
 - [ReturnOrderLine](docs/ReturnOrderLine.md)
 - [ReturnOrderLineDetails](docs/ReturnOrderLineDetails.md)
 ...
 - [User](docs/User.md)
 - [UspsHazmatType](docs/UspsHazmatType.md)
 ...
 - [ZipCodeZone](docs/ZipCodeZone.md)
 - [Zone](docs/Zone.md)
